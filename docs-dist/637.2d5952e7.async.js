      ...
      var e = n(67294),
        ...
        E = (A, I, L) =>
          I in A
            ...
            : (A[I] = L),
        S = (A, I) => {
          for (var L in I || (I = {})) p.call(I, L) && E(A, L, I[L]);
          if (m) for (var L of m(I)) d.call(I, L) && E(A, L, I[L]);
          return A;
        };
      const z = (A) =>
        e.createElement(
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
      ...
      function j(A, I) {
        ...
        for (var L = 0, k = new Array(I); L < I; L++) k[L] = A[L];
        return k;
      }
      function v(A, I) {
        var L =
      ...
      function D(A) {
        var I = A.pathname,
          ...
          F =
            'base' in L
              ? I.replace(L.base.replace(/\/$/, ''), '') || '/'
              : I.replace(new RegExp(''.concat(L.suffix, '$')), '');
        return 'base' in k
          ? ''
      ...
      var Z = function (I) {
          var L = I.locale,
            ...
            re = (0, e.useState)(function () {
              return D({ pathname: J, current: k, target: L });
            }),
            ae = C(re, 2),
            oe = ae[0],
            ue = ae[1];
          return (
            (0, e.useEffect)(
              function () {
                ue(D({ pathname: J, current: k, target: L }));
              },
              [J, k.id, L.id],
            ),
            e.createElement(
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
      ...
      var Ae = function () {
          ...
          return (
            ...
            b.length
              ? d.createElement(L, { sectionRefs: b }, function (U) {
